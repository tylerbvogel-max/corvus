...
# Record 04 seam 4 moved the result shape and the nine recall algorithms out of
# this module so the pipeline stages and structural_resolver could stop importing
# it back. Re-exported here because routers, eval scripts and tests import them
# from executor; new code should import from the modules below directly.
from app.services.prepared_context import PreparedContext  # noqa: F401
from app.services.recall_primitives import (  # noqa: F401
    _apply_inhibition_and_boost,
    _assemble_top_slice,
    _embed_query_async,
    _load_candidates_by_ids,
    _load_neuron_map,
    _neighbor_vote_classify,
    _run_hybrid_lanes,
    _select_and_score_candidates,
    _tally_neighbor_votes,
)
