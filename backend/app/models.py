...
# ── Retired compliance context: table declarations only ─────────────
# The compliance capability was retired on 2026-08-01 by roadmap record
# durability-compliance-disposition. The code is recoverable from
# ~/Projects/corvus-compliance-context (tag compliance-context-2026-08-01);
# these six tables are NOT, because they were never removed.
#
# The three classes below moved here verbatim from app/compliance/models.py
# when that package was deleted. They stay declared for one reason: rows still
# exist in corvus_aero, yggdrasil, corvus_roost and others, and a table that
# leaves Base.metadata is a table alembic autogenerate proposes to DROP. They
# have no routes and no services. Do not add either without re-granting the
# capability; see the roadmap record before touching this block.
